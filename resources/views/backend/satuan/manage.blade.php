...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('backend.satuan.manage') }}">Satuan</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Kelola Satuan</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('backend.satuan.create') }}" class="btn btn-circle green">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    <td> {{ $no }}</td>
                                    <td> {{ $row->nama }}</td>
                                    <td> {{ $row->status == '1' ? 'Aktif':'Tidak Akftif' }}</td>
                                    <td class="center" width="100">
                                        <a href="{{ route('backend.satuan.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                                <?php $no++ ?>
                            @endforeach
