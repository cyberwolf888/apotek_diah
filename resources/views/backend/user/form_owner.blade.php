...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('backend.user.owner.manage') }}">Owner</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase"> Form Owner</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    {!! Form::open(['route' => isset($update) ? ['backend.user.owner.update', $model->id] : 'backend.user.owner.store', 'files' => true]) !!}
                    <div class="form-body">
                        @if (count($errors) > 0)
