    ...
    <div class="row widget-row">
        <div class="col-md-4">
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Total Penjualan</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-green icon-bulb"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">{{ date('F') }}</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_penjualan }}">{{ $total_penjualan }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
        ...
        <div class="col-md-4">
            <!-- BEGIN WIDGET THUMB -->
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                <h4 class="widget-thumb-heading">Total Pembelian</h4>
                <div class="widget-thumb-wrap">
                    <i class="widget-thumb-icon bg-red icon-layers"></i>
                    <div class="widget-thumb-body">
                        <span class="widget-thumb-subtitle">{{ date('F') }}</span>
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_pembelian }}">{{ $total_pembelian }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_pembelian+$total_penjualan }}">{{ $total_pembelian+$total_penjualan }}</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
