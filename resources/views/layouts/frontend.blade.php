...
<!-- Mirrored from remtsoy.com/tf_templates/the_box/demo_v1_6/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2018 16:31:50 GMT -->
<head>
    ...
    <link rel="stylesheet" href="{{ url('assets') }}/frontend/css/mystyles.css">
    <link rel="stylesheet" href="{{ url('assets') }}/frontend/css/switcher.css" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/bright-turquoise.css" title="bright-turquoise" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/turkish-rose.css" title="turkish-rose" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/salem.css" title="salem" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/hippie-blue.css" title="hippie-blue" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/mandy.css" title="mandy" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/green-smoke.css" title="green-smoke" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/horizon.css" title="horizon" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/cerise.css" title="cerise" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/brick-red.css" title="brick-red" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/de-york.css" title="de-york" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/shamrock.css" title="shamrock" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/studio.css" title="studio" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/leather.css" title="leather" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/denim.css" title="denim" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="{{ url('assets') }}/frontend/css/schemes/scarlet.css" title="scarlet" media="all" />
</head>
...
<div class="global-wrapper clearfix" id="global-wrapper">
    <div class="navbar-before mobile-hidden">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="navbar-before-sign">Semua obat yang kamu butuhkan ada disini</p>
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img src="{{ url('assets') }}/frontend/img/logo-w.png" alt="Image Alternative text" title="Image Title" />
                </a>
            </div>
            <div class="collapse navbar-collapse" id="main-nav-collapse">
                <ul class="nav navbar-nav">
                    <li class="dropdown"><a href="#"><i class="fa fa-reorder"></i>&nbsp; Kategori Produk<i class="drop-caret" data-toggle="dropdown"></i></a>
                ...
                <div class="container">
                    <div class="slider-item-inner">
                        <div class="slider-item-caption-left slider-item-caption-white">
                            <h4 class="slider-item-caption-title">Diskon 50%</h4>
                            <p class="slider-item-caption-desc">Untuk setiap pembelian condom</p><a class="btn btn-lg btn-ghost btn-white" href="#">Lihat Detail</a>
                        </div>
                        <img class="slider-item-img-right" src="{{ url('assets') }}/frontend/img/test_slider/1.png" alt="Image Alternative text" title="Image Title" style="top: 60%; width: 56%;" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="payment-icons-list">
                        <li>
                            <img src="{{ url('assets') }}/frontend/img/payment/visa-straight-32px.png" alt="Image Alternative text" title="Pay with Visa" />
                        </li>
                        <li>
                            <img src="{{ url('assets') }}/frontend/img/payment/mastercard-straight-32px.png" alt="Image Alternative text" title="Pay with Mastercard" />
                        </li>
                        <li>
                            <img src="{{ url('assets') }}/frontend/img/payment/paypal-straight-32px.png" alt="Image Alternative text" title="Pay with Paypal" />
                        </li>
                        <li>
                            <img src="{{ url('assets') }}/frontend/img/payment/visa-electron-straight-32px.png" alt="Image Alternative text" title="Pay with Visa-electron" />
                        </li>
                        <li>
                            <img src="{{ url('assets') }}/frontend/img/payment/maestro-straight-32px.png" alt="Image Alternative text" title="Pay with Maestro" />
                        </li>
                        <li>
                            <img src="{{ url('assets') }}/frontend/img/payment/discover-straight-32px.png" alt="Image Alternative text" title="Pay with Discover" />
                        </li>
                    </ul>
                </div>
            </div>
...
<script src="{{ url('assets') }}/frontend/js/ionrangeslider.js"></script>
<script src="{{ url('assets') }}/frontend/js/jqzoom.js"></script>
<script src="{{ url('assets') }}/frontend/js/card-payment.js"></script>
